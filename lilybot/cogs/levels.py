...
class Levels(Cog):
    ...
    async def meesyncs(self, ctx: LilyBotContext):
    ...
    @guild_only()
    async def checkrolelevels(self, ctx: LilyBotContext):
    ...
    @guild_only()
    async def adjustlevels(self, ctx: LilyBotContext):
    ...
    `{prefix}adjustlevels swapxp <@Snowplow or "Snowplow"> <@LilyBot or "LilyBot">`:\n Swaps Snowplow's xp with LilyBot's xp
    `{prefix}adjustlevels transferxp <@Snowplow or "Snowplow"> <@LilyBot or "LilyBot">`:\n Adds Snowplow's xp to LilyBot's xp
    """

    @adjustlevels.command()
    @guild_only()
    @has_permissions(manage_messages=True)
    async def setlevel(self, ctx: LilyBotContext, member: discord.Member, level: int):
    ...
    @guild_only()
    @has_permissions(manage_messages=True)
    async def adjustxp(self, ctx: LilyBotContext, member: discord.Member, xp_amount: int):
    ...
    @guild_only()
    @has_permissions(manage_messages=True)
    async def swapxp(self, ctx: LilyBotContext, take_member: discord.Member, give_member: discord.Member):
    ...
    @guild_only()
    @has_permissions(manage_messages=True)
    async def transferxp(self, ctx: LilyBotContext, take_member: discord.Member, give_member: discord.Member):
    ...
    @guild_only()
    async def configureranks(self, ctx: LilyBotContext):
        """Configures LilyBot ranks:tm:"""
    ...
    async def xprange(self, ctx: LilyBotContext, xp_min: int, xp_max: int):
    ...
    @guild_only()
    @has_permissions(manage_guild=True)
    async def setcooldown(self, ctx: LilyBotContext, cooldown: int):
    ...
    @guild_only()
    @has_permissions(manage_guild=True)
    async def toggle(self, ctx: LilyBotContext):
        """Toggle LilyBot ranks"""
        await self._cfg_guild_setting(ctx, toggle_enabled=True)

    @configureranks.command()
    @guild_only()
    @has_permissions(manage_guild=True)
    async def keeproles(self, ctx: LilyBotContext):
    ...
    @guild_only()
    @has_permissions(manage_guild=True)
    async def notificationchannel(self, ctx: LilyBotContext, channel: discord.TextChannel):
    ...
    @guild_only()
    @has_permissions(manage_guild=True)
    async def notificationsoff(self, ctx: LilyBotContext):
    ...
    async def setrolelevel(self, ctx: LilyBotContext, role: discord.Role, level: int):
    ...
    @guild_only()
    @has_permissions(manage_roles=True)
    async def removerolelevel(self, ctx: LilyBotContext, role: discord.Role):
        """Removes a levelrole"""
        e = discord.Embed(color=blurple)
    ...
    async def _cfg_guild_setting(self, ctx: LilyBotContext, xp_min=None, xp_max=None, xp_cooldown=None,
    ...
    async def rank(self, ctx: LilyBotContext, *, member: discord.Member = None):
    ...
    # @cog_ext.cog_slash(name="leaderboard", description="Returns the guilds LilyBot leaderboard")
    ...
    @guild_only()
    async def levels(self, ctx: LilyBotContext, start: typing.Optional[discord.Member]):
