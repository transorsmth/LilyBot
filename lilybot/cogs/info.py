...
class Info(Cog):
    ...
    async def member(self, ctx: LilyBotContext, *, member: discord.Member = None):
    ...
    async def role(self, ctx: LilyBotContext, role: discord.Role):
    ...
    async def guild(self, ctx: LilyBotContext):
