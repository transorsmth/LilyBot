...
class Fun(Cog):
    ...
    async def battle(self, ctx: LilyBotContext, opponent: discord.Member, delete_result: bool = True):
    ...
    @command()
    async def fight(self, ctx: LilyBotContext, opponent: discord.Member, wager: int = 0):
        """Start a fight with another user."""
